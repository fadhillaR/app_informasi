...
import 'package:app_informasi/admin/search/SearchPilkada.dart';
...
class ListPilkadaAdmin extends StatefulWidget {
  const ListPilkadaAdmin({super.key});

  @override
  State<ListPilkadaAdmin> createState() => _ListPilkadaAdminState();
}

class _ListPilkadaAdminState extends State<ListPilkadaAdmin> {
