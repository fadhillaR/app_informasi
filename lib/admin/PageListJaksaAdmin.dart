...
import 'package:app_informasi/admin/search/SearchJaksa.dart';
...
class ListJaksaAdmin extends StatefulWidget {
  const ListJaksaAdmin({super.key});

  @override
  State<ListJaksaAdmin> createState() => _ListJaksaAdminState();
}

class _ListJaksaAdminState extends State<ListJaksaAdmin> {
                              ...
                              child: InkWell(
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => DetailJaksaAdmin(data)),
                                  );
                                },
                                child: Stack(
                                  children: [
