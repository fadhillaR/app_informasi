...
class SearchHukumAdmin extends StatefulWidget {
  const SearchHukumAdmin({Key? key});

  @override
  State<SearchHukumAdmin> createState() => _SearchHukumAdminState();
}

class _SearchHukumAdminState extends State<SearchHukumAdmin> {
  ...
  if (hukum != null) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => DetailHukumAdmin(hukum)),
    );
  } else {
