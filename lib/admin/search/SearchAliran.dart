...
class SearchAliranAdmin extends StatefulWidget {
  const SearchAliranAdmin({Key? key});

  @override
  State<SearchAliranAdmin> createState() => _SearchAliranAdminState();
}

class _SearchAliranAdminState extends State<SearchAliranAdmin> {
  ...
  if (aliran != null) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => DetailAliranAdmin(aliran)),
    );
  } else {
