...
class SearchPegawaiAdmin extends StatefulWidget {
  const SearchPegawaiAdmin({Key? key});

  @override
  State<SearchPegawaiAdmin> createState() => _SearchPegawaiAdminState();
}

class _SearchPegawaiAdminState extends State<SearchPegawaiAdmin> {
  ...
  if (pegawai != null) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => DetailPegawaiAdmin(pegawai)),
    );
  } else {
