...
import 'package:app_informasi/admin/search/SearchKorupsi.dart';
...
class ListKorupsiAdmin extends StatefulWidget {
  const ListKorupsiAdmin({super.key});

  @override
  State<ListKorupsiAdmin> createState() => _ListKorupsiAdminState();
}

class _ListKorupsiAdminState extends State<ListKorupsiAdmin> {
