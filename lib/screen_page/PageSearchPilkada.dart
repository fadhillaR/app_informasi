...
class PageSearchPilkada extends StatefulWidget {
  const PageSearchPilkada({Key? key});

  @override
  State<PageSearchPilkada> createState() => _PageSearchPilkadaState();
}

class _PageSearchPilkadaState extends State<PageSearchPilkada> {
  ...
  if (pilkada != null) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => PageDetailPilkada(pilkada)),
    );
  } else {
