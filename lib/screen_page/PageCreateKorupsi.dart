...
class createKorupsi extends StatefulWidget {
  const createKorupsi({Key? key}) : super(key: key);

  @override
  State<createKorupsi> createState() => _createKorupsiState();
}

class _createKorupsiState extends State<createKorupsi> {
...
Future<void> _getUserId() async {
  ...
  Future<int> _simpan() async {
    var request = http.MultipartRequest('POST',
        Uri.parse('http://192.168.100.6/informasiDb/createKorupsi.php'));
            ...
            children: [
              Container(
                ...
                child: Stack(children: [
                  Text(
                    '\t\tTambah Data Pengaduan Tindak Pidana Korupsi',
                    style: TextStyle(
                      fontSize: 20,
                              ...
                              _simpan().then((value) {
                                if (value == 1) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content:
                                          Text('Berhasil tambah data Pengaduan Tindak Pidana Korupsi!'),
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content:
                                          Text('Gagal tambah data Pengaduan Tindak Pidana Korupsi'),
