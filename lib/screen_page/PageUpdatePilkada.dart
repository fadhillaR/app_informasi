...
class UpdatePilkada extends StatefulWidget {
  ...
  @override
  State<UpdatePilkada> createState() => _UpdatePilkadaState();
}
...
class _UpdatePilkadaState extends State<UpdatePilkada> {
  ...
  Future<int> _update() async {
    var request = http.MultipartRequest('POST',
        Uri.parse('http://192.168.100.6/informasiDb/updatePilkada.php'));
    request.fields['id_pilkada'] = widget.idPilkada;
                              ...
                              _update().then((value) {
                                if (value == 1) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content:
                                          Text('Berhasil update data Posko Pilkada!'),
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text('Gagal update data Posko Pilkada'),
