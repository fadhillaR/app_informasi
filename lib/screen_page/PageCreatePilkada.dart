...
class createPilkada extends StatefulWidget {
  const createPilkada({Key? key}) : super(key: key);

  @override
  State<createPilkada> createState() => _createPilkadaState();
}

class _createPilkadaState extends State<createPilkada> {
...
Future<void> _getUserId() async {
  ...
  Future<int> _simpan() async {
    var request = http.MultipartRequest('POST',
        Uri.parse('http://192.168.100.6/informasiDb/createPilkada.php'));
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.pushAndRemoveUntil(
                context,
                MaterialPageRoute(builder: (context) => PageListPilkada()),
                (route) => false);
          },
        ),
        toolbarHeight: 50,
                              ...
                              _simpan().then((value) {
                                if (value == 1) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content:
                                          Text('Berhasil tambah data Posko Pilkada!'),
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content:
                                          Text('Gagal tambah data Posko Pilkada'),
