...
class createAliran extends StatefulWidget {
  const createAliran({Key? key}) : super(key: key);

  @override
  State<createAliran> createState() => _createAliranState();
}

class _createAliranState extends State<createAliran> {
...
Future<void> _getUserId() async {
  ...
  Future<int> _simpan() async {
    var request = http.MultipartRequest('POST',
        Uri.parse('http://192.168.100.6/informasiDb/createAliran.php'));
            ...
            children: [
              Container(
                ...
                child: Stack(children: [
                  Text(
                    '\t\tTambah Data Pengawasan Aliran dan Kepercayaan',
                    style: TextStyle(
                      fontSize: 20,
                              ...
                              _simpan().then((value) {
                                if (value == 1) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content:
                                          Text('Berhasil tambah data Pengawasan Aliran dan Kepercayaan!'),
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content:
                                          Text('Gagal tambah data Pengawasan Aliran dan Kepercayaan'),
