...
class UpdateHukum extends StatefulWidget {
  final String idHukum;
  final String idUser;
  ...
  @override
  State<UpdateHukum> createState() => _UpdateHukumState();
}

class _UpdateHukumState extends State<UpdateHukum> {
  ...
  Future<int> _update() async {
    var request = http.MultipartRequest('POST',
        Uri.parse('http://192.168.100.6/informasiDb/updateHukum.php'));
    request.fields['id_hukum'] = widget.idHukum;
                              ...
                              _update().then((value) {
                                if (value == 1) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content:
                                          Text('Berhasil update data Penyuluhan Hukum!'),
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text('Gagal update data Penyuluhan Hukum'),
