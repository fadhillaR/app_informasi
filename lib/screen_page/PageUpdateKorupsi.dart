...
class UpdateKorupsi extends StatefulWidget {
  final String idKorupsi;
  final String idUser;
  ...
  @override
  State<UpdateKorupsi> createState() => _UpdateKorupsiState();
}

class _UpdateKorupsiState extends State<UpdateKorupsi> {
  ...
  Future<int> _update() async {
    var request = http.MultipartRequest('POST',
        Uri.parse('http://192.168.100.6/informasiDb/updateKorupsi.php'));
    request.fields['id_korupsi'] = widget.idKorupsi;
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.pushAndRemoveUntil(
                context,
                MaterialPageRoute(builder: (context) => PageListKorupsi()),
                (route) => false);
            ...
            children: [
              Container(
                ...
                child: Stack(children: [
                  Text(
                    '\t\tUpdate Data Pengaduan Tindak Pidana Korupsi',
                    style: TextStyle(
                      fontSize: 20,
                              ...
                              _update().then((value) {
                                if (value == 1) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content:
                                          Text('Berhasil update data Pengaduan Tindak Pidana Korupsi!'),
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text('Gagal update data Pengaduan Tindak Pidana Korupsi'),
