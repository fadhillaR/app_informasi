...
class PageSearchKorupsi extends StatefulWidget {
  const PageSearchKorupsi({Key? key});

  @override
  State<PageSearchKorupsi> createState() => _PageSearchKorupsiState();
}

class _PageSearchKorupsiState extends State<PageSearchKorupsi> {
  ...
  if (korupsi != null) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => PageDetailKorupsi(korupsi)),
    );
  } else {
